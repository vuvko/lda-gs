...
/*
 * Сделать вычисление перплексии после каждой итерации (при мерно 500-1500)
 * Сгенерировать модельные данные
 *   Генерация через Дирихле
 *   Кол-во документов N
 *   Кол-во слов в док. Mn
 *   Сравнение венгерским алгоритмом (возможно несовподающее число тем)
 */
